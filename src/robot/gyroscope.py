...
if __name__ == "__main__":
    ...
    setup_logger('perform_spin_test_logger', r'perform_spin_test_logger.log')
    logger = logging.getLogger('perform_spin_test_logger')

    perform_spin(90, 90, TB, mpu, max_power, logger)
