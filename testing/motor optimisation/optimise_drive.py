...
def search(TB, mpu, max_power, logger):
    ...
    for _ in range(4): # search for 10 steps
        ...
        elif abs(total_rotation) < abs(best_total_rotation):  # if new is best
            best_total_rotation = total_rotation
            best_motor2_optimal_power = motor2_optimal_power
...
if __name__ == "__main__":
    ...
    setup_logger('calibration', r'calibration.log')
